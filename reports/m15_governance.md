...
### seed=0
- **grader**:坏品拦截 {'fact_error': 1.0, 'stale': 1.0, 'harmful': 1.0, 'injection': 1.0}、良品误杀 0.0、延迟 1.373ms、成本 $0.0

### seed=1
- **grader**:坏品拦截 {'fact_error': 1.0, 'stale': 1.0, 'harmful': 1.0, 'injection': 1.0}、良品误杀 0.0、延迟 0.541ms、成本 $0.0
